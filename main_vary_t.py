...
def main_vary_t(dataset_name='Chamelon',epsilon=2,e1_r=1/3,e2_r=1/3,N=20,t_List=[0.2,0.5,0.8,1.0,1.2,1.5],exp_num=10,save_csv=False):
    ...
    cols = ['eps','exper','t','nmi','evc_overlap','evc_MAE','deg_kl', \
    ...
    for ti in range(len(t_List)):
        ...
        for exper in range(exp_num):
            ...
            mat1_pvarr1 = community_init(mat0,mat0_graph,epsilon=e1,nr=n1,t=t)
            ...
            data_col = [epsilon,exper,t,nmi,evc_overlap,evc_MAE,deg_kl, \
                diam_rel,cc_rel,mod_rel]
...
if __name__ == '__main__':
    ...
    # set the resolution parameter, list type
    t_List = [0.2,0.5,0.8,1.0,1.2,1.5]
